...
RUN curl -s "http://solder.endermedia.com/repository/downloads/the-1122-pack/the-1122-pack_1.1.2.zip" -o /data/the-1122-pack_1.1.2.zip
RUN unzip the-1122-pack_1.1.2.zip && rm the-1122-pack_1.1.2.zip
